...
const Map<String, List<String>> sss3Topics = {
  'Numbers & Numeration': [
    'Roman Number System',
...
class Sss3TopicsScreen extends StatelessWidget {
  const Sss3TopicsScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                children: [
                  for (final entry in sss3Topics.entries)
                    _TopicExpansionTile(
                      topic: entry.key,
        ...
        children: [
          for (final subtopic in subtopics)
            ListTile(
              ...
              onTap: () {
                context.push(
                  '/sss3-topic/${Uri.encodeComponent(topic)}/${Uri.encodeComponent(subtopic)}',
                );
              },
            ),
        ],
