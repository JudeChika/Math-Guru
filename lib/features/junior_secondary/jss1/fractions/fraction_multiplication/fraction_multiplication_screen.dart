...
import 'fraction_multiplication_logic.dart';

class FractionMultiplicationScreen extends StatefulWidget {
  const FractionMultiplicationScreen({super.key});

  @override
  State<FractionMultiplicationScreen> createState() => _FractionMultiplicationScreenState();
}

class _FractionMultiplicationScreenState extends State<FractionMultiplicationScreen> {
  ...
  void _calculateMultiplication() {
    ...
    final solution = FractionMultiplicationLogic.solve(inputs);
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              "Enter fractions to multiply (e.g. 1/2, 3/4, 2 1/3, 5):",
            ...
            Center(
              child: ElevatedButton(
                ...
                child: const Text("Multiply Fractions", style: TextStyle(color: Colors.white)),
              ),
            ),
            const SizedBox(height: 20),
            if (_result != null)
