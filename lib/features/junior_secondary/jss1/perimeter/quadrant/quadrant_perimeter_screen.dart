...
import 'quadrant_perimeter_solver.dart';
import 'quadrant_perimeter_models.dart';

class QuadrantPerimeterScreen extends StatefulWidget {
  const QuadrantPerimeterScreen({super.key});

  @override
  State<QuadrantPerimeterScreen> createState() => _QuadrantPerimeterScreenState();
}

class _QuadrantPerimeterScreenState extends State<QuadrantPerimeterScreen> {
  ...
  void _solve() {
    ...
    setState(() {
      ...
      if (r != null) {
        _result = QuadrantPerimeterSolver.solveForPerimeter(r);
      } else if (p != null) {
        _result = QuadrantPerimeterSolver.solveForRadius(p);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    bool isRDisabled = _pController.text.isNotEmpty;
    bool isPDisabled = _rController.text.isNotEmpty;

    return Scaffold(
      appBar: AppBar(title: const Text('Perimeter of a Quadrant')),
